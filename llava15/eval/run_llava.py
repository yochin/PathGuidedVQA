...
def init_llava15_model(model_path, model_base):
    # Model
    disable_torch_init()
...
def run_llava15_model(tokenizer, model, image_processor, context_len, input_query, image_files, input_conv_mode, input_temperature, input_top_p, input_num_beams, input_max_new_tokens, model_name):
