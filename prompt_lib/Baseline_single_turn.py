...
def get_prompt(goal_label_cxcy, bboxes, trial_num, sep_system=False, add_LCR_prompt=False):
    ...
    list_prompt1.append(f'Assume the user is moving along a 2-meter-wide path from the starting point [0.5, 1.0] to the destination {dest_descriptions} in the image. '
                        'Provide the response in a structured format with numbered sections to separate the details clearly: \n'
    )
    ...
    list_prompt1.append('5. Overall Scene and Pedestrian Traffic Light: \n'
                        f'Describe where the user is located based on the image. '
    ...
    list_prompt1.append('6. Walkability Evaluation: \n'
