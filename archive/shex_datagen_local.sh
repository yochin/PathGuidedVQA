...
#CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python generate_data_by_yochin.py --llava-model-dir /mnt/data_disk2/models/vlms/llava/llava-v1.6-34b --model-name llava16_cli --db-dir /mnt/data_disk/dbs/gd_datagen/val100 --prompt-id 91188 --output res/datagen/output_t988
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python generate_data_by_yochin.py --llava-model-dir /mnt/data_disk2/models/vlms/llava/llava-v1.6-34b --model-name llava16_cli --db-dir /mnt/data_disk/dbs/gd_datagen/val100 --prompt-id 91198 --output res/datagen/output_t998
...
do
    ...
    python prepare_eval.py --gt-dir res/datagen/output_t"$tt"/qa --output-dir res/datagen/output_t"$tt"/eval --prompt-id 1118 | tee res/logs/log_${task_name}_t"$tt".txt
done
...
for tt in 998
do
    python eval_accuracy.py --pred-dir res/datagen/output_t"$tt" --gt-dir /mnt/data_disk/dbs/gd_datagen/val100/anno | tee res/logs/log_${task_name}_t"$tt"_score.txt
done
