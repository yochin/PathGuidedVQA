...
def run_llava_model(tokenizer, model, image_processor, context_len, input_query, image_files, input_conv_mode, input_temperature, input_top_p, input_num_beams, input_max_new_tokens, model_name):
